...
function AboutPage() {
    const aboutItems = [
        { image: About1, title: "Take a step-by-step approach", description: "No more feeling lost in class. When you’re taught every step and how each one builds on the other, you’re never left scratching your head in confusion." },
        { image: About2, title: "Empower students to realize their", description: "Memorization only gets you so far. You’ll learn the why and the how behind calculus so you can problem solve on your own." },
        { image: About3, title: "Make the journey fun", description: "Learning math doesn’t have to be scary or stressful. You’ll enjoy your classes when you’re able to piece." }
    ];
        ...
        <>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center py-12 bg-gray-50 md:px-12 px-4">
                <div className="w-full md:w-1/3 mb-6 md:mb-0 pr-0 md:pr-8">
                    <img src={girlImage} alt="about-image" className="rounded-md" />
                </div>
